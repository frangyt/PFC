...
function ShowStats()
{
   ...
   if (pass.length <= 4)
   {
      r += "<b>CUIDADO:  <font color=red>Senha muito curta!</font></b><br>\n";
   }
   else if (pass.length < 8)
   {
      r += "<b>CUIDADO:</b>  <font color=red>Senha curta!</font><br>\n";
   }
   ...
   for (var i = 0; i < Common_Words.length; i ++)
   {
	 ...
	 r += "<b>CUIDADO:  <font color=red>Senha Comum!</font></b><br>\n";
      }
   }
   ...
   if (pass.length > 1)
   {
	 ...
	 aidx = bidx;
      ...
      if (bits < 28)
      {
         r += "<b>Força:  <font color=red>Muito Fraca</font></b> - ";
	 r += "para aumentar a senha tente colocar letras maiúsculas ou ";
	 r += "adicionar simbolos.<br>\n";
      }
      else if (bits < 36)
      {
         r += "<b>Força:</b>  <font color=red>Fraco</font> - ";
	 r += "para aumentar a senha tente colocar letras maiúsculas ou ";
	 r += "adicionar simbolos.<br>\n";
      }
      else if (bits < 60)
      {
         r += "<b>Força:</b>  <font color=brown>Média</font> - ";
	 r += "Sua senha ainda não esta 100% tente ";
	 r += "adicionar mais caracteres para melhora-la <br>\n";

      }
      else if (bits < 128)
      {
         r += "<b>Força:</b>  <font color=green>Forte</font> - ";
	 r += "Sua senha esta forte mas sempre ";
	 r += "é possível melhorar.<br>\n";
      }
      else
      {
         r += "<b>Força:</b>  <font color=blue>Muito Forte</font> - ";
	 r += "Essa senha ta monstra, nada vai te hackear agora.<br>\n";
      }
