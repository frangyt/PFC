...
<script language="Javascript">
    function confirma(id) {
        if (confirm("Deseja remover esse item?"))
            window.location.href = "produto_processa.php?cmd=del&id="+id;
    }
</script>

<div class="jumbotron">
    <h2>Estados</h2>
    <p><a class="btn btn-primary btn-large" href="produto_form.php?id=">Adicionar Campeonato <span class="glyphicon glyphicon-plus-sign"></span></a></p>
