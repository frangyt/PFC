    ...
    <div class="collapse navbar-collapse" id="navbar-collapse-01">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            if (isset($_SESSION["idusuario"])) {
                echo   "<td><a class='btn btn-primary btn-lg btn-inverse' href='pagina%20admin.php'>" .$_SESSION["nome"]. "</a><a class='btn btn-primary btn-lg btn-inverse' href='logout.php'>Sair</a></td>";
            }
